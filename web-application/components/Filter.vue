    ...
    <div class="flex">
      <div class="lg:w-[66%]">
        <div class="text-slate-400 p-4 overflow-y-auto text-justify mx-4">
          Welcome to the Smart Urban Gardening Assistant! This intuitive platform helps you manage your plants effortlessly. 
          The header features a search function and an option to add plants. You can also adjust language settings, 
          personalize user preferences, or securely log out. Below, stay informed about crucial environmental conditions for your plants. 
          A convenient table summarizes key details of all your plants, making management a breeze 🌱
        </div>
